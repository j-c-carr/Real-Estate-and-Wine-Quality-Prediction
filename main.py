...
# print('sklean precision: ', precision_score(y_wine_test, y_preds_bin, average='weighted'))
# print('sklean recall: ', recall_score(y_wine_test, y_preds_bin, average='weighted'))
# print('sklean f1: ', f1_score(y_wine_test, y_preds_bin, average='weighted'))
